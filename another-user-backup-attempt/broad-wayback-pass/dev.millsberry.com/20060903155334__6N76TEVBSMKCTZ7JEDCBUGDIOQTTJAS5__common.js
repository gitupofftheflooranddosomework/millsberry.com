...
function flash_object (src, width, height, flash_vars, version, scale) {
	...
	document.write ("<embed type='application/x-shockwave-flash' src='" + src + "' width='" + width + "' height='" + height + "' quality='high' wmode='transparent' scale='" + scale + "' pluginspage='http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash' AllowScriptAccess='always' FlashVars='" + flash_vars + "'></embed>");
