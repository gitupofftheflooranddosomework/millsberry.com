...
var cossette_tlaTLAHeight = 485; //flash height
var cossette_tlaTLAWidth = 590; //flash width
var cossette_tlaisIE4Up = (document.all) ? 1 : 0;
var cossette_shiftleftoffset = 0;
//if(cossette_tlaisIE4Up) cossette_shiftleftoffset = 0;
var cossette_tlastartTopLayerAddX = parseInt(cossette_tlagetPageWidth()) - parseInt(cossette_tlaTLAWidth) - cossette_shiftleftoffset; //starting x location on page (Centered)
...
var cossette_timelimit = 25; // minutes to wait for activity break check
...
function move_cossette_tlaTopLayerAd(show){
	//cossette_tlastartTopLayerAddX = parseInt(cossette_tlagetPageWidth()) - parseInt(cossette_tlaTLAWidth) - cossette_shiftleftoffset; //starting x location on page (Centered)
	//cossette_tlastartTopLayerAddY = parseInt(cossette_tlagetPageHeight()/2) - parseInt(cossette_tlaTLAHeight/2) ;//starting y location on screen (Centered)
