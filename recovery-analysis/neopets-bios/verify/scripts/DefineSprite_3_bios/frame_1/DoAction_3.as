this.startTransitionToFinish = function()
{
   ...
   trace("-------------START MOVING  " + _loc2_.chipGraphic);
   trace("---------and  START MOVING " + _loc2_.bgGraphic);
   _loc2_.onEnterFrame = _loc2_.alphaUpChip;
};
this.alphaUpChip = function()
{
   var _loc2_ = this;
   _loc2_.chipGraphic._aStep = 4 + (100 - _loc2_.chipGraphic._alpha) / 10;
...
{
   var _loc2_ = this;
   _loc2_.bgGraphic._aStep = -1 - _loc2_.bgGraphic._alpha / 10;
